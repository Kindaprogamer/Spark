...
module.exports = {
    ...
    callback: async ({message,args}) => {
        ...
        if(!opponent) {
            return message.channel.send('you have to mention someone to play with you sad fuck, thinking you can play yourself')
        }
        ...
        if(reaction.emoji.name === '❌') {
            return question.edit('Looks like they didnt want to play sad')
        } else {
